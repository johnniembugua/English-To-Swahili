...
class _TranslateTextPageState extends State<TranslateTextPage> {
  ...
  Translator _translator = Translator(from: ENGLISH, to: SWAHILI);
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      // Predownload translation model for Swahili
      await TranslationModelManager.download(SWAHILI);
    });
  }
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 15),
              NormalBlueButton(
                text: 'Translate from Eng to Swahili',
